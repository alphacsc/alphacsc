...
class ConvBPDNJoint(ConvBPDN):
    ...
    hdrtxt_objfn = ('Fnc', 'DFid', u('Regl1'), u('Regl2,1'))
    hdrval_objfun = {'Fnc' : 'ObjFun', 'DFid' : 'DFid',
                     u('Regl1') : 'RegL1', u('Regl2,1') : 'RegL21'}
...
class ConvElasticNet(ConvBPDN):
    ...
    hdrtxt_objfn = ('Fnc', 'DFid', u('Regl1'), u('Regl2'))
    hdrval_objfun = {'Fnc' : 'ObjFun', 'DFid' : 'DFid',
                     u('Regl1') : 'RegL1', u('Regl2') : 'RegL2'}
