...
def test_get_solver_d(rank1, solver_d, window, momentum):
    ...
    d_solver = get_solver_d(N_TIMES_ATOM,
                            solver_d=solver_d,
                            rank1=rank1,
                            window=window,
                            momentum=momentum)
...
def test_init_dictionary(X, D_init, solver_d, uv_constraint, window):
    ...
    D_hat = d_solver.init_dictionary(X, N_ATOMS, uv_constraint, D_init=D_init)
...
def test_init_dictionary_rank1_random(X, solver_d, uv_constraint,
    ...
    D_hat = d_solver.init_dictionary(
        X, N_ATOMS, uv_constraint, D_init='random')
...
def test_init_shape(X, rank1, solver_d, uv_constraint, expected_shape, window):
    ...
    D_hat = d_solver.init_dictionary(X, N_ATOMS, uv_constraint)
